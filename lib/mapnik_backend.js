...
MapnikSource.prototype._createMetatileCache = function() {
    ...
    600000, // purge non-consumed cache entries after 10 minutes to prevent a memorrhage
    true); // purge immediately after callbacks
};
...
MapnikSource.prototype.flush = function(callback) {
    try {
